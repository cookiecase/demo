...
namespace demo
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Unnamed_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand com = new SqlCommand("update role set rolename=@name,roletype=@type,pemission=@per where id=@id", con);
                com.Parameters.AddWithValue("@rolename", RoleName.Text);
                com.Parameters.AddWithValue("@roletype", RoleType.SelectedItem);
